...
namespace BulkyWeb.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        //    Product? product = _unitOfWork.Product.Get(u => u.Id == id);    //works only on the primary key.
        //    //Product? category1 = _db.Categories.FirstOrDefault(u => u.Id == id);   //This will work for other fields also (doesnt have to be a primary key).
